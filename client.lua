...
Citizen.CreateThread(function()
	while true do
                ...
                if coordonate[i] ~= nil then
                    if metrii2 <=3 then
                        ...
                        if IsControlJustPressed(1,51) then
                            ...
                            exports['mythic_notify']:SendAlert('inform', '1 Mushroom added', 2500)
        ...
        if metrii <= 3 then
            perform = true
            DrawText3D(pos.x,pos.y,pos.z+0.6, "To become a Mushroom Farmer ~y~[E]~w~ \n To sell mushrooms ~y~[Y]~w~", 1.2)
            if IsControlJustPressed(1,51) then
                ...
                exports['mythic_notify']:SendAlert('inform', 'Mushroom Basket Added, Lets Pick Mushrooms', 2500)
                ...
                elseif hasjob == true then
                    exports['mythic_notify']:SendAlert('inform', 'You have already been hired as a Mushroom Farmer.', 2500)
                end
            elseif IsControlJustPressed(1,246) then
                ...
                DeleteEntity(cosdeoua)
                    ...
                    exports['mythic_notify']:SendAlert('inform', 'Keep Looking.', 2500)
